...
public class InstamojoImpl implements Instamojo {
    ...
    public static Instamojo getApi(String clientId, String clientSecret, String apiEndpoint, String authEndpoint)
            throws ConnectionException {
				...
				LogLevel.DEBUG(5, new Throwable(), "Bang !  1");
    ...
    public static Instamojo getApi(String clientId, String clientSecret) throws ConnectionException {
		LogLevel.DEBUG(5, new Throwable(), "Bang !  2");
    ...
    private static Instamojo getInstamojo(String clientId, String clientSecret, String apiEndpoint, String authEndpoint)
            throws ConnectionException {
				LogLevel.DEBUG(5, new Throwable(), "uniqueInstance :" + uniqueInstance);
        if (uniqueInstance == null) {
			LogLevel.DEBUG(5, new Throwable(), "Step 1" );
            synchronized (InstamojoImpl.class) {
				LogLevel.DEBUG(5, new Throwable(), "Step 2" );
                if (uniqueInstance == null) {
					LogLevel.DEBUG(5, new Throwable(), "Step 3" );
					LogLevel.DEBUG(5, new Throwable(), "clientId :" + clientId);
					LogLevel.DEBUG(5, new Throwable(), "clientSecret :" + clientSecret);
					LogLevel.DEBUG(5, new Throwable(), "apiEndpoint :" + apiEndpoint);
					LogLevel.DEBUG(5, new Throwable(), "authEndpoint :" + authEndpoint);
					...
					LogLevel.DEBUG(5, new Throwable(), "accessToken :" + accessToken);
					LogLevel.DEBUG(5, new Throwable(), "uniqueInstance :" + uniqueInstance);
                }
            }
        } else {
    ...
    private static boolean isTokenExpired() {
		...
		LogLevel.DEBUG(5, new Throwable(), "durationInSeconds :" + durationInSeconds);
		//LogLevel.DEBUG(5, new Throwable(), "accessToken.getExpiresIn() - 300 :" + accessToken.getExpiresIn());
    ...
    private static AccessTokenResponse getAccessToken(String clientId, String clientSecret, String authEndpoint)
		...
		LogLevel.DEBUG(5, new Throwable(), "getAccessToken Step 1 A ");

        try {
			
			LogLevel.DEBUG(5, new Throwable(), "getAccessToken Step 1 B ");
			
            String response = HttpUtils.sendPostRequest(authEndpoint, null, params);
			
			LogLevel.DEBUG(5, new Throwable(), "response: "+response);
            ...
            if (TextUtils.isEmpty(accessTokenResponse.getToken())) {
				LogLevel.DEBUG(5, new Throwable(), "Could not get the access token due to " + accessTokenResponse.getError());
			...
			LogLevel.DEBUG(5, new Throwable(), "Error " + e);
