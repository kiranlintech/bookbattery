...
Vector alist=(Vector)session.getAttribute("sesMisExchangeVector");
			...
			<div class="body">
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover dataTable js-exportable">
						<thead>
							<tr class="header bg-brown">
								<th>SR.NO</th>
								<th>DATE</th>
								<th>BATTERY TYPE RETURNED</th>
								<th>BRAND RETURNED</th>
								<th>BATTERY NAME</th>  
								<th>MODEL/CAPACITY RETURNED</th>
								<th>QUANTITY RETURNED</th> 
								<th>BATTERY TYPE EXCHANGED</th>
								<th>BRAND EXCHANGED</th>
								<th>BATTERY NAME EXCHANGED</th> 
								<th>MODEL/CAPACITY EXCHANGED</th>  
						  	...
						  	<%
								...
								if(alist!=null && alist.size() > 0)
								{
										...
										for(int i=0;i<alist.size();i++)
										{
											...
											String batterytype=String.valueOf(ht.get("battery_type"));
											...
											String battery_quantity = String.valueOf(ht.get("battery_quantity"));
											
											String battery_type_exchanged=String.valueOf(ht.get("battery_type_exchanged"));
 											String battery_brand_exchanged = String.valueOf(ht.get("battery_brand_exchanged"));
											String battery_name_exchanged=String.valueOf(ht.get("battery_name_exchanged"));
											String battery_model_exchanged = String.valueOf(ht.get("battery_model_exchanged"));
											String battery_quantity_exchanged = String.valueOf(ht.get("battery_quantity_exchanged"));
											...
											<td><%=battery_name%></td> 
											<td><%=battery_model%></td>
											<td><%=battery_quantity%></td> 
											<td><%=battery_type_exchanged%></td> 
											<td><%=battery_brand_exchanged%></td> 
											<td><%=battery_name_exchanged%></td> 
											<td><%=battery_model_exchanged%></td>											
											<td><%=battery_quantity_exchanged%></td> 
											</tr>
											<%
										}
									%>
