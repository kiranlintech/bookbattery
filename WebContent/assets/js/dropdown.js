		...
		if (product_make=="0" || product_make=="default" || product_make==""){
			...
			$("#product_brand").html("<option>Select Brand</option>");
			 ...
			 $.ajax({					 
				...
				data: {vehiclename: product_make, batterytype:product_type,fueltype:""},
				success: function(data)
				{	
						    ...
						    else
							{
								...
								setCookie("product_make_cookie", product_make);
									...
									({					 
										type: "GET",
										url: "/bookbattery/servlet/BatteryHome?hidWhatToDo=getvehicle_model",
										data: {vehiclename: $("#product_make").val(),fueltype: "",batterytype:$("#product_type").val()},
										success: function(data)
											{
...
function RequestProductDetails_Step_2()
{
	...
	product_make_URL= product_make.replace(/ /g, "-");
			...
			//var url=publicUrl+'/bookbattery/'+product_type_URL+'/'+product_make_URL+'/'+product_model_URL+'/'+product_fuel_URL+'/'+product_state_URL+'/'+product_city_URL+'/'+product_brand_URL+'/'+Filter_Battery_Warranty_URL+'/';
