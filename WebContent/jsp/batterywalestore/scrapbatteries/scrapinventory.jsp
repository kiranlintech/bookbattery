                    ...
                    <div class="card">
                        ...
                        <div class="body">
                               <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                         <button type="button" class="btn bg-amber waves-effect" onclick="GetReports()">
                            ...
                            <div class="row clearfix" id="scrapinventory_report"></div>
						</div>
                    </div>
                </div>
            </div>
...
function GetReports(){
  ...
  var store_name = $("#store_name").val();
	...
	$.ajax({
			type: "GET",
			url: "/bookbattery/servlet/BatterystoreScrapDetails?hidWhatToDo=getscrapinventoryreport",
			data: {fromdate : fromdate, todate: todate, store_name: store_name},
			success: function(data){
				
				//alert(data); 
				$("#scrapinventory_report").html(data);
