...
<form name="userloyalty" action="">
	...
	<table border='0' cellpadding="0" width="950" align="center">
		...
		<table width="950" border="0" class="insidecontent c24" align="center" cellspacing="0" cellpadding="0" >
			<tr>
				<td height="2"><div id='scrollpopups'  style="display:block;"><table width="100%" border="0" align="center" valign="top"><tr><td align='right' class='loading_image'></td></tr><tr><td align='center' style='font-family:Verdana;font-size:12px;color:#000000; text-decoration:none;padding:1px 1px;'>Please wait page is loading....</td></tr></table></div></td></td>
			</tr>
			<tr>
				<td>
									...
									<tr>
												<td>
													<table width="100%" border="0" align="center">
														<tr>
															<td width="25%"></td>
															<td align="left" class = "subheading">User Redeem Points</td>
														</tr>
													</table>
													<table border="0" width="100%" align="center" border="0">
														<tr>
															...
															<td>
																<table width='500'  border='0' align='center' valign='top' border='0'>
																	<tr></tr>
																	<tr>
																			...
																			<tr>
																				<td>
																					<table align='center' width='360' border='0' cellspacing='0' cellpadding='0'>
																						<tr>
																							<td class='click' align='left'>Earned User Loyalty Points-0</td>
																						</tr>
																					</table>
																				</td>
																			</tr>
...
function merchantdetails()
{
	...
	var  url="/bookbattery/servlet/ConsumerLoyalty?hidWhatToDo=dispmerchantLoyalty&emailid="+Email+"&requestno="+(Math.random()*100);
	var xmlhttp= "";
	var resp= "";
...
function addmerchantreedem()
{
	...
	var url="/bookbattery/servlet/ConsumerLoyalty?hidWhatToDo=updateBrandloyaltypoints&mobileno="+mobileno+"&reedempoints="+userreedempoints+"&loyalpoints="+merchantpoints+"&loyaltyid="+loyaltyid+"&serviceprovider="+serviceprovider+"&state="+state+"&requestno="+(Math.random()*100);
	if (window.XMLHttpRequest)
	{
		xmlhttp=new XMLHttpRequest();
	}
...
function close_merchntreedemclose()
{
	...
	document.userloyalty.action="/bookbattery/servlet/UserLoginDetails?hidWhatToDo=merchantLoyalty&emailid="+Email;
...
{	
	...
	if (flag=="merchant")
	{
		var url="/bookbattery/servlet/ConsumerLoyalty?hidWhatToDo=updateBrandloyaltypoints&useraddress="+useraddress+"&mobileno="+mobileno+"&reedempoints="+userreedempoints+"&loyalpoints="+merchantpoints+"&loyaltyid="+loyaltyid+"&flag=profile&requestno="+(Math.random()*100);
	}
	else
	{
		var url="/bookbattery/servlet/ConsumerLoyalityPoints?hidWhatToDo=redeemPoints&useraddress="+useraddress+"&mobileno="+mobileno+"&reedempoints="+userreedempoints+"&flag=profile&requestno="+(Math.random()*100);
	}
	if (window.XMLHttpRequest)
	{
		xmlhttp=new XMLHttpRequest();
