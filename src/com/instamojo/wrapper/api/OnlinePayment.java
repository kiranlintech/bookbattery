...
public class OnlinePayment extends HttpServlet 
{
    ...
    public OnlinePayment(QueryManager qm) 
	{
        qmgr=qm;
    }
	...
	private static final Logger LOGGER = Logger.getLogger(OnlinePayment.class.getName());
	//######### This method is used to get cookies Of State and City
	public String getPaymentLink(HttpServletRequest req, HttpServletResponse res, HttpSession session, String UserName,String UserEmail,String UserMobileNumber,String WithoutOldBatteryPrice,String TransactionId)
	{
		String result="";
		String Order_ID=TransactionId;
		
		LogLevel.DEBUG(5, new Throwable(), "URL Setted"+URL);
		...
		double WithoutOldBatteryPrice_Double = Double.parseDouble(WithoutOldBatteryPrice);
		LogLevel.DEBUG(5, new Throwable(), "WithoutOldBatteryPrice_Double :" + WithoutOldBatteryPrice_Double);
		...
		order.setAmount(WithoutOldBatteryPrice_Double);
		...
		//order.setRedirectUrl("http://localhost:8080/bookbattery/transaction/");
		//order.setWebhookUrl("http://localhost:8080/bookbattery/transaction/");
		//**/
		
		// gets the reference to the instamojo api Test Payment API
		
		//order.setRedirectUrl("http://192.168.1.95/bookbattery/transaction/");
		//order.setWebhookUrl("http://192.168.1.95/bookbattery/transaction/");		
		//order.setRedirectUrl("http://192.168.1.95/bookbattery/transaction/");
		//order.setWebhookUrl("http://192.168.1.95/bookbattery/transaction/");
		...
		try {
				...
				//api = InstamojoImpl.getApi("MQnKDs5nu1liwIMatnaEEHPAuggS6ORSZSnanDQb", "V7rpcELsUNID5rmYcw0Y8hxdanho1laxYl2eGSpiqcPJJ4g54vo3PYnW7Sc9XNUDqqG30nRnsZadF7WEfAsCqaKmopIXRL1JOBNZtkAqjDCAdYT8MLVAkitjszr2DkZX", "https://test.instamojo.com/v2/", "https://test.instamojo.com/oauth2/token/");
	...
	public String getPaymentOrderDetails(String TransactionId)
	{
		...
		try {
			...
			//Instamojo api = InstamojoImpl.getApi("MQnKDs5nu1liwIMatnaEEHPAuggS6ORSZSnanDQb", "V7rpcELsUNID5rmYcw0Y8hxdanho1laxYl2eGSpiqcPJJ4g54vo3PYnW7Sc9XNUDqqG30nRnsZadF7WEfAsCqaKmopIXRL1JOBNZtkAqjDCAdYT8MLVAkitjszr2DkZX", "https://test.instamojo.com/v2/", "https://test.instamojo.com/oauth2/token/");
