...
$("#botInput1").on("tap", function() {
    $.metroMessageBox({
        ...
        content:"Our Team will Call you soon",
        buttons:[ "Call Me", "Close"],
        defaultbutton:1,
        input: "tel",
        // showcounter: false,
        placeholder:"9603467559",
		...
		if(button=="Close")
			...
			if(value=="")
				...
				$.ajax({
                    ...
                    type: "GET",
                    url: "/bookbattery/servlet/BatteryDetails?hidWhatToDo=insertvisitor",
                    data: {Usermobileno: value},
