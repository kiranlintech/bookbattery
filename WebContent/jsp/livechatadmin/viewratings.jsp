...
Description			: Live Chat Agents Ratings.
--%>
...
<title>Live Chat Agents Ratings</title>
</head>
...
<td bgcolor='#FFFFFF'>
	<table width="713" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td class="subheading"><font size="2">View Live Chat Agent Ratings</td>
		</tr>
		<tr>
			<td>
				<table width="100%" cellspacing="1" bgcolor="#FFFFFF" cellpadding="0">
					<tr>
						...
						if(alist==null || alist.size() == 0)
						{
							%>
							<tr>
								<td colspan="3" align="center"> There are no Chat Agent ratings available.
								</td>
							</tr>	
							<tr bgcolor="#FFFFFF">
								...
								<td>
									<table  width="100%" cellspacing="1"  cellpadding="2" bgcolor="#dddddd">
										<tr  bgcolor="#2364b1">
											...
											<td align="center" class="prodheading" width="30%">ChatAgent Emailid</td>
											<td align="center" class="prodheading" width="20%">User Emailid</td>
											<td align="center" class="prodheading" width="20%">User MobileNumber</td>
											<td align="center" class="prodheading" width="20%">User Name</td>
											<td align="center" class="prodheading" width="23%">User Rating</td>
											<td align="center" class="prodheading" width="23%">Creation Date</td>
										...
										try
										{
											...
											for ( int i=0; i<alist.size() ; i++)
											{
												...
												String user_email=(String)ht.get("user_email");
												String user_rating=String.valueOf(ht.get("user_rating"));
												String agent_emailid=String.valueOf(ht.get("agent_emailid"));
												String username=String.valueOf(ht.get("user_name"));
												String creationdate=String.valueOf(ht.get("creation_date"));
												String user_mobile_number=(String)ht.get("user_mobile_number");
												...
												if (j==(j/2)*2)
												{
													...
													<tr bgcolor="#aaaaaa">
														...
														<td  class="table1" width="30%"><%=agent_emailid%></td>
														<td  class="table1" width="20%"><%=user_email%></td>
														<td  class="table1" width="20%"><%=user_mobile_number%></td>
														<td  class="table1" width="20%"><%=username%></td>
														<td  class="table1" width="23%"><%=user_rating%></td>
														<td  class="table1" width="23%"><%=creationdate%></td>
													</tr>
													<%
												}
												else
...
document.fetchaccount.method="post";
document.fetchaccount.action="../../servlet/LiveChatManagement?hidWhatToDo=fetchchatagentsratings&pagenumber="+pagenumber+"&pagetype=first";
document.fetchaccount.submit();
}
...
var pagenumber=document.fetchaccount.pagenumber.value;
document.fetchaccount.method="post";
document.fetchaccount.action="../../servlet/LiveChatManagement?hidWhatToDo=fetchchatagentsratings&pagenumber="+pagenumber+"&pagetype=previous";
document.fetchaccount.submit();
}
...
var pagenumber=document.fetchaccount.pagenumber.value;
document.fetchaccount.method="post";
document.fetchaccount.action="../../servlet/LiveChatManagement?hidWhatToDo=fetchchatagentsratings&pagenumber="+pagenumber+"&pagetype=next";
document.fetchaccount.submit();
}
...
var pagenumber=document.fetchaccount.pagenumber.value;
document.fetchaccount.method="post";
document.fetchaccount.action="../../servlet/LiveChatManagement?hidWhatToDo=fetchchatagentsratings&pagenumber="+pagenumber+"&lastpage="+lastpage+"&pagetype=last";
document.fetchaccount.submit();
}
...
document.fetchaccount.method="post";
document.fetchaccount.action="../../servlet/LiveChatManagement?hidWhatToDo=fetchchatagentsratings&pagenumber="+pagenumber;			
document.fetchaccount.submit();
}
</script>
<script type='text/javascript'>
