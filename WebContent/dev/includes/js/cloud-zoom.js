  ...
  function CloudZoom(jWin, opts) {
    ...
    this.init = function() {
      ...
      /* Add a box (mouseTrap) over the small image to trap mouse events.
             ...
             */
      jQuerymouseTrap = jWin.parent().append(format("<div class='mousetrap' style='background-image:url(\"" + opts.transparentImage + "\");z-index:999;position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;cursor: crosshair;\'></div>", sImg.outerWidth(), sImg.outerHeight(), 0, 0)).find(':last');
