<%--
	...
	File name  : franchiseedetails.jsp
...
$(document).ready(function()
{
	...
	function(){
		 var splitval =$selectedcity.val();
		 	 if(splitval == "default")
			 {
				for(i=document.findfranchisee.service.options.length-1;i>=1;i--)
				{
				document.findfranchisee.service.remove(i);
				}
				$('#divfranchiseedetails').hide();
				document.findfranchisee.city.focus();
			 }
			...
			
			 {
                ...
                $.ajax({
                    type: "GET",
                    url: "../../../servlet/FindFranchiseeDetails?hidWhatToDo=getservice",
                    data: { city: $selectedcity.val()},
                    success: function(data)
					{
                        $("#service").html(data)
						document.findfranchisee.service.focus();
                    }
                });
			}
         }
...
function funFranchiseeDetails()
{
		...
		var service=document.findfranchisee.service.value;
		 ...
		 if(document.findfranchisee.city.value == "default")
		 {
		  ...
		  if(document.findfranchisee.service.value == "default")
		 {
			 $("#displayerrormsg").show();
			errMsg ="<font color='#FF3333'>Please select Service</font>";
			document.getElementById("displayerrormsg").innerHTML=errMsg;
			document.findfranchisee.service.focus();
			return ;
		 }
		...
		var xmlhttp= "";
		var resp= "";
		var url ="../../../servlet/FindFranchiseeDetails?hidWhatToDo=getfranchiseedetails&state="+state+"&city="+city+"&service="+service;
						...
						<tr>
							...
							<table width="100%" cellspacing="1" align="center" bgcolor="#FFFFFF" cellpadding="0" border="0">
								<table width="650" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
									<tr><td align="left" width="50%" class="subheading">Franchisee Details</td><td width="50%"align="right"><a href="../../../servlet/OperatorLogin?hidWhatToDo=servicesoperatorhome" class="onclick1">Back&nbsp;&nbsp;</a></td></tr>
																...
																<td bgcolor="#FFFFFF" align="center">
																	<table width="80%" align="center" border="0" cellspacing="0" bgcolor="#FFFFFF" cellpadding="0">
																		...
																		<tr>
																			...
																			<tr>
																			<td width="39%" class="insidecontent" align="right">Select&nbsp;Service<font color="FF0000">*</font>&nbsp;:</td>
																			<td width="59%" class="insidecontent" align="left">
																				<select name="service" id="service"  class="insidecontent" style='width:180px'>
																		...
																		<tr><td align="center" class="insidecontentservices"><div id="divfranchiseedetails" style="width:770px;height:200px;  overflow:scroll; overflow-X:auto; overflow-Y:auto; -webkit-overflow-scrolling: touch;display:none;"></div></td></tr>
