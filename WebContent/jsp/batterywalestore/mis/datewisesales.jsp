                    ...
                    <div class="card">
                        ...
                        <div class="body">
                               <div class="row clearfix">
								...
								<br/>
                                    <div class="form-group">
                                         <button type="button" class="btn bg-green waves-effect" onclick="GetBatteriesSalesReports()">
                            ...
                            <div class="row clearfix" id="batterysales_report"></div>
						</div>
                    </div>
                </div>
            </div>
...
function GetBatteriesSalesReports(){
	...
	$.ajax({
		type: "GET",
		url: "/bookbattery/servlet/BatterystoreInventoryDetails?hidWhatToDo=getsalesreport",
		data: {fromdate : fromdate, todate: todate, brand_type: brand_type, store_name: store_name},
		success: function(data){
			
			//alert(data); 
			$("#batterysales_report").html(data);
