<%--
    Document   : View Retailer invoice
    File name  : viewretailerinvoice.jsp	
    Created on : Feb 13th, 2016
		...
		xmlhttp.onreadystatechange=function()
		{
			if (xmlhttp.readyState==4)
			{
				...
				else 
				{
					...
					$("#invoicetype").html("<option style='background:#FFF' value='' class='topindex1'>Select&nbsp;Invoice&nbsp;Type</option><option style='background:#FFF' value='services'>Services</option>");
				}
			}			
		}		
...
function FunReset()
{
	location.href="../../../../jsp/admin/servicesstore/mis/viewretailerinvoice.jsp"
}
</script>
<style type="text/css">
</style>
		...
		<tr>
			...
			<td width="75%" align="left" valign="top">
				...
				<tr>
					...
					<tr>
						<td align="left" valign="top">
							<tr>
								...
								<td  align="right"><a href="../../../../servlet/AdminServicesLogin?hidWhatToDo=servicesadminhome" class="onclick1">Back&nbsp;&nbsp;</a></td>
							</tr>
							<tr><td height="5"></td></tr>
							<tr><td align="center" class="insidecontentservices"><div id="showerror"></div><div id="divcreatepdf"></div></td></tr>
							<td>
					...
					<tr><td height="5"></td></tr>
					<tr><td align="center" class="insidecontentservices"><div style="width:770px;height:200px;  overflow:scroll; overflow-X:auto; overflow-Y:auto; -webkit-overflow-scrolling: touch;"><div id="divviewpdf"></div></div></td></tr>
	</td>
	</tr>
	</table>		
	</td>
