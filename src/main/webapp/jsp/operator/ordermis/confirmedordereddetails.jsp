															...
															<div style="width:1320px;height:400px;  overflow:scroll; overflow-X:auto;  -webkit-overflow-scrolling: touch;" id='div1'>
																<table width="100%" cellspacing="1"  cellpadding="2" bgcolor="#dddddd">
																	<tr  bgcolor="#cccccc">
																		...
																		<th align="center" class="subheading"><font color="#000000">Cus&nbsp;Name/Emailid/Mobile</font></th>
																		<th align="center" class="subheading"><font color="#000000">Ret&nbsp;Name/Mobile</font></th>
																		...
																		<th align="center" class="subheading"><font color="#000000">Veh&nbsp;Make/Model</font></th>
																		<th align="center" class="subheading"><font color="#000000">Brand/Model</font></th>
																		...
																		<th align="center" class="subheading"><font color="#000000"> Confirm&nbsp;By</font></th>
																		...
																		<th align="center" class="subheading"><font color="#000000"> State/City</font></th>
																		...
																		<th align="center" class="subheading"><font color="#000000"> First Contacted Date</font></th>
																	...
																	for(int i=0;i<alist.size();i++)
																	{
																		...
																		area=(String)ht.get("area");
																		LogLevel.DEBUG(1,new Throwable(),"area in jsp: "+area);
																...
																String Final_Price_price = Integer.toString(Price_Temp_price*QTY_int);
																	...
																	<tr bgcolor="#DAD0E1">
																		...
																		if(battype.equals("Bike Batteries") && delivery_mode.equals("Yes"))
																		{ 
																		%> 
																		bgcolor='#04BEFED9'
																		<%
																		...
																		else if(payment_mode.equals("Store UPI PhonePe"))
																		{
																		%>
																		bgcolor='#CDDC39'
																		<%
																		...
																		<td  class="insidecontent" align="left"><%=vehname%></br><%=vehmake%> </td>
																		<td  class="insidecontent" align="left"><a data-toggle="popover" title="Battery Capacity" date-placement="top" data-content="<%=battery_capacity%>" style="color: #000001;  cursor: alias;"> <%=battery%></br><%=model%></a> </td>
																		...
																		%>
																		<td  class="insidecontent <% if (order_type.equals("Replaced")){	%> battery_order_type<%}%>" align="left">Rs.<%=obrpprice%>&nbsp;X&nbsp;<%=quantity%></a>
...
function Updatevisitorstatus(orderid,ordernumber,state,city,area,batterytype,cusmobile, PaymentMode, order_type)
{
	//alert(orderid);
		//alert(ordernumber);
	...
	{
		//alert(area);
		Ordertoretailer(orderid,ordernumber,orderedstatus,state,city,area,batterytype,cusmobile, PaymentMode, order_type)
	}
...
{	
	...
	$("#batmodel").html("<option value='0' selected=''>&nbsp;Select&nbsp;Battery&nbsp;Model</option>");
	$("#vehmodel").html("<option value='0' selected=''>&nbsp;Select&nbsp;Vehicle&nbsp;Model</option>");
	$("#batprice").val(" ");
	$("#witholdbatprice").val(" ");
}
...
function Ordertoretailer(orderid,ordernumber,orderstatus,state,city,area,batterytype,cusmobile, PaymentMode, order_type)
{
