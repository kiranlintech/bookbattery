								...
								<div class="card">
									...
									<div class="col-md-offset-2">
										...
										if((battery_type=="Bike Batteries") || (battery_type.equals("Bike Batteries"))&&(service_type=="Jump Start") || (service_type.equals("Jump Start"))) { %>
											 ...
											 <button type="button" class="btn bg-deep-orange waves-effect" disabled="disabled" onclick="javascript:OrderService('<%=service_type%>','<%=battery_type%>','<%=store%>','Store')">ORDER SERVICE NOW</button>
											
										<% } else { %>
											
											 <button type="button" class="btn bg-deep-orange waves-effect"  onclick="javascript:OrderService('<%=service_type%>','<%=battery_type%>','<%=store%>','Store')">ORDER SERVICE NOW</button>
								...
								<div class="card">
									...
									<div class="col-md-offset-2">		
										...
										<%}%>  <br/>
											...
											<br/>
										  <button type="button" class="btn bg-indigo waves-effect" onclick="javascript:OrderService('<%=service_type%>','<%=battery_type%>','<%=within_5km%>','Within 5 KM')">ORDER SERVICE NOW</button>
									</div>
									</div>
								</div>
							</div>
								...
								<div class="card">
									...
									<div class="col-md-offset-2">
										...
										if((battery_type=="Bike Batteries") || (battery_type.equals("Bike Batteries"))){ %>
											...
											<button type="button" class="btn bg-brown waves-effect" disabled="disabled"  onclick="javascript:OrderService('<%=service_type%>','<%=battery_type%>','<%=within_5km%>','Within 10 KM')">ORDER SERVICE NOW</button>
											
										<% } else { %>
											
											<button type="button" class="btn bg-brown waves-effect"  onclick="javascript:OrderService('<%=service_type%>','<%=battery_type%>','<%=within_5km%>','Within 10 KM')">ORDER SERVICE NOW</button>
