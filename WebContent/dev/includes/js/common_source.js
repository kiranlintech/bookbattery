...
jQuery('#hideDiv2').on("click", function() {
  jQuery("#hideShow").hide();
}); 

jQuery('#hideDiv3').on("click", function() {
  jQuery("#help_slider").hide();
  jQuery("#help_slider_small").show();
}); 
...
jQuery.fn.UItoTop = function(options) {
  ...
  jQuery(containerIDhash).hide().on("click", function() {
    ...
    return false;
  }).prepend('<span class="'+ settings.containerHoverID +'" id="' + settings.containerHoverID + '"></span>').hover(function() {
...
// $(".dropdown-2-open").hover(function () {
     // $(this).addClass("open");
// });
...
$(".dropdown-2-open").hover(
  function() {
    $( this ).addClass( "open" );
  }, function() {
	 setTimeout(function(){
		$(".dropdown-2-open").removeClass( "open" );
	}, 100);
  }
);
