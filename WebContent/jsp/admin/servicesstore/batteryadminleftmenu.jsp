							...
							<tr>
								...
								<td height="25" align="left" valign="middle" onmouseover="expand(this);" onmouseout="collapse(this);"><a href="/bookbattery/jsp/admin/batterystore/retailers/addretailer.jsp" class="category">Retailers</a><div class="menuNormal" width="120">
										<table class="menu" width="80">
											...
											<tr>
												<td class="menuNormal"><a href="/bookbattery/jsp/admin/batterystore/retailers/modifyretailer.jsp" class="menuitem">Modify&nbsp;Retailer</a></td>
											</tr>
											<tr>
				...
				<tr>
					<td>
						<table width="180" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="20" align="left" valign="middle"><img src="/bookbattery/images/arrow-right.png" width="16" height="16" /></td>
								<td height="25" align="left" valign="middle" onmouseover="expand(this);" onmouseout="collapse(this);"><a href="/bookbattery/jsp/admin/batterystore/mis/misoptions.jsp" class="category">MIS</a>
								<div class="menuNormal" width="120">
										<table class="menu" width="80">
											<tr>
											...
											<tr>
												<td class="menuNormal"><a href="/bookbattery/servlet/GenerateRetailerInvoice?hidWhatToDo=getretailers" class="menuitem">Generate&nbsp;Retailer&nbsp;Invoice[Batteries]</a></td>
											</tr>
											<tr>
