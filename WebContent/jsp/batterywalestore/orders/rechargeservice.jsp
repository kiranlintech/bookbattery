								...
								<div class="row clearfix">
									 <div class="" id="orderform_state">
										...
										<div class="col-md-3  pull-right">
											<br/>
											<button type="button" class="btn bg-deep-purple waves-effect" onclick="GetRechargedetails()">
													<i class="material-icons">search</i>
													<span>FIND RECHARGE DETAILS</span>
												</button>
										</div> 
									...
									<!---------------------Pincode Starts ----------------------->
									 <div class="" id="orderform_pincode" style="display:none;">
										...
										<div class="col-md-6 col-lg-3 col-xs-12  pull-right">
										<br/>
												<button type="button" class="btn bg-deep-purple waves-effect" onclick="GetRechargedetails()">
													<i class="material-icons">search</i>
													<span>FIND RECHARGE DETAILS</span>
...
function GetRechargedetails(){
	...
	document.orderservice.action="../../../servlet/BatterystoreServiceDetails?hidWhatToDo=getrechargedetails&batterytype="+batterytype+"&vehiclename="+vehiclemake+"&vehiclemodel="+vehiclemodel+"&batt_capacity="+batt_capacity+"&state="+state+"&city="+city+"&area="+area+"&pincode="+pincode+"&service_type="+service_type;
