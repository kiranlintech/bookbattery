		...
		<table  border="0" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" align="left" valign="middle" >
					<a href="/bookbattery/admin/index.html"><img src="/bookbattery/assets/img/logo/bookbatterylogo.jpeg" width="auto" height="80px" border="0"/></a>
				</td>
...
<tr>
	<td align = "left" valign = "top">
		<table  border="0" width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td width="50%" align="left" valign="middle" >
					<a href="/bookbattery/servlet/AdminBatteryLogin?hidWhatToDo=batteryadminhome"><img src="/bookbattery/assets/img/logo/bookbatterylogo.jpeg" width="auto" height="80px" border="0"/></a>
				</td>
				<td width="50%" valign="center">
					<table class="insidecontent" valign="center" border="0" align="center" cellspacing="0"  cellpadding="0" width="100%">
						<tr>
