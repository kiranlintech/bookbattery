...
Vector alist=(Vector)session.getAttribute("sesMisScrapVector");
						  	...
						  	<%
								...
								if(alist!=null && alist.size() > 0)
								{
										...
										for(int i=0;i<alist.size();i++)
										{
											...
											String battery_weight = String.valueOf(ht.get("battery_weight"));
											String Date = String.valueOf(ht.get("Date"));
											double bw = Double.parseDouble(battery_weight);
											String Qty = String.valueOf(ht.get("Qty"));
											double d = Double.parseDouble(Qty);
											LogLevel.DEBUG(1,new Throwable(),"scrapprice JKSP: "+Qty);
											//int QTY_int = Integer.parseInt(Qty);
											
											String scrapprice = String.valueOf(ht.get("price"));
											//int Price_Temp_price = Integer.parseInt(scrapprice);
											double Price_Temp_price = Double.parseDouble(scrapprice);
											LogLevel.DEBUG(1,new Throwable(),"scrapprice JKSP: "+scrapprice);
											double Final_Price = Price_Temp_price * d * bw;
											LogLevel.DEBUG(1,new Throwable(),"Final_Price_obrpprice JKSP: "+Final_Price);
