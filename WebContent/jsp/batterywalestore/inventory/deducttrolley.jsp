					 ...
					 <form class="form-horizontal" id="myform">
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
                                        <label for="battery_type">Select Trolley Brand:&nbsp;<font color="red">*</font></label>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-3 col-sm-5 col-xs-12">
                                        <label for="battery_capacity">Select Trolley Model:&nbsp;<font color="red">*</font></label>
                                    </div>
                                    <div class="col-lg-9 col-md-9 col-sm-7 col-xs-12">
                                        <div class="form-group">
                                            <div class="form-line"> 
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-6 col-xs-offset-6">
                                        <button type="button" class="btn bg-indigo m-t-15 waves-effect" onclick="funtoDeleteInventoryDetails()">ADD TROLLEY</button>
...
function funtoDeleteInventoryDetails(){
	...
	var trolley_model =  $("#trolley_model").val();
	if (selectValidation("","trolley_model","select") == false)
	{
		return;
	...
	var storeid	= $("#storeid").val();
	  ...
	  $.ajax({
			type: "GET",
			url: "/bookbattery/servlet/BatterystoreInventoryDetails?hidWhatToDo=deductedtrolleyinventory",
			data: {trolley_brand: trolley_brand, trolley_model: trolley_model, quantity: quantity, storename: storename, storeid: storeid },
			success: function(data){
 				//alert(data);
