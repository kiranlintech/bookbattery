                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-grey">
                            <h2>
                               GENERATE TROLLEY INVENTORY REPORT
                            </h2>
                        </div>
                        <div class="body">
                               <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                         <button type="button" class="btn bg-grey waves-effect" onclick="GetReports()">
											<i class="material-icons">search</i>
											<span>GENERATE TROLLEY REPORT</span>
										</button>  
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix" id="trolleyinventory_report"></div>
						</div>
                    </div>
                </div>
            </div>
...
function GetReports(){
  ...
  var store_name = $("#store_name").val();
	...
	$.ajax({
			type: "GET",
			url: "/bookbattery/servlet/BatterystoreInventoryDetails?hidWhatToDo=gettrolleyinventoryreport",
			data: {fromdate : fromdate, todate: todate, store_name: store_name},
			success: function(data){
				
				//alert(data); 
				$("#trolleyinventory_report").html(data);
