...
public class Inverter_Battery_Combo_Details extends HttpServlet 
{  
		...
		try
			{
				...
				RequestDispatcher RD = getServletContext().getRequestDispatcher("/jsp/inverter_and_battery_combo_details.jsp");
				RD.forward(req, res);
				out.close();
			}
			catch (Exception e)
	...
	String City="";
		...
		{	
			...
			Manufacturer =java.net.URLDecoder.decode(REQ_URL_Array[1], "UTF-8");
			Inverter_Model =java.net.URLDecoder.decode(REQ_URL_Array[2], "UTF-8");
			Inverter_Battery_Model =java.net.URLDecoder.decode(REQ_URL_Array[3], "UTF-8");
			Inverter_Battery_Capacity =java.net.URLDecoder.decode(REQ_URL_Array[4], "UTF-8");
			//Battery_Type= Battery_Type.replaceAll("-", " ");
			//Vehicle_Name= Vehicle_Name.replaceAll("-", " ");
			
			if(REQ_URL_Array.length>=6){
				State =java.net.URLDecoder.decode(REQ_URL_Array[5], "UTF-8");
			}
			else{
				State ="Karnataka";
			}
			if(REQ_URL_Array.length>=7){
				City =java.net.URLDecoder.decode(REQ_URL_Array[6], "UTF-8");
			}
			else{
				City ="Bangalore";
			}
			...
			String Get_Inverter_Details_SQL = "select DISTINCT a.inverter_brand,a.inverter_model,a.inverter_name,a.inverter_capacity,a.inverter_warranty,a.computer,a.fans,a.tubelights,a.television,a.icon_url,a.description,b.inverter_actual_price,b.inverter_discount_price,a.inverter_battery_supported_ah,a.inverter_battery_pcs,b.model_stock from inverter_details a, inverter_price_details b  where  b.state='"+State+"' and b.city='"+City+"' and a.inverter_brand='"+Manufacturer+"' and a.inverter_model='"+Inverter_Model+"' and  b.inverter_model='"+Inverter_Model+"' LIMIT 1";  
			...
			else
			{
					...
					String Get_Inverter_Battery_SQL = "select DISTINCT a.bat_brand,a.bat_type,a.bat_model,a.bat_capacity,a.bat_name,a.bat_warranty, a.icon_url,a.description,b.bat_act_price,b.bat_witbat_price,b.bat_ret_price,a.battery_type_flag,b.model_stock from application_chat_mapping a, batteryprice b where a.bat_type='Inverter Batteries' and a.battery_type_flag in ('Tall Tubular Battery','Flat Plate Battery','Tubular Battery') and b.state='"+State+"' and b.city='"+City+"'  and a.bat_brand=b.bat_brand and a.bat_capacity='"+Inverter_Battery_Capacity+"' and a.bat_model='"+Inverter_Battery_Model+"' and  b.bat_model='"+Inverter_Battery_Model+"'  LIMIT 1";
				 ...
				 //### SQL to Get Inverter Combo Percentage ####End
					...
					{
						int j=0;
						Hashtable ht_Inverter_Battery=(Hashtable)Vector_Inverter_Battery.get(j);
						req.setAttribute("Inverter_Battery_Brand",String.valueOf(ht_Inverter_Battery.get("bat_brand")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Brand :" + String.valueOf(ht_Inverter_Battery.get("bat_brand")));
						
						req.setAttribute("Inverter_Battery_Type",String.valueOf(ht_Inverter_Battery.get("bat_type")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Type :" + String.valueOf(ht_Inverter_Battery.get("bat_type")));
						
						req.setAttribute("Inverter_Battery_Model",String.valueOf(ht_Inverter_Battery.get("bat_model")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Model :" + String.valueOf(ht_Inverter_Battery.get("bat_model")));

						req.setAttribute("Inverter_Battery_Capacity",String.valueOf(ht_Inverter_Battery.get("bat_capacity")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Capacity :" + String.valueOf(ht_Inverter_Battery.get("bat_capacity")));
						
						req.setAttribute("Inverter_Battery_Warranty",String.valueOf(ht_Inverter_Battery.get("bat_warranty")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Warranty :" + String.valueOf(ht_Inverter_Battery.get("bat_warranty")));
						
						req.setAttribute("Inverter_Battery_Name",String.valueOf(ht_Inverter_Battery.get("bat_name")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Name :" + String.valueOf(ht_Inverter_Battery.get("bat_name")));
						
						req.setAttribute("Inverter_Battery_Image",String.valueOf(ht_Inverter_Battery.get("icon_url")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Image :" + String.valueOf(ht_Inverter_Battery.get("icon_url")));
						
						req.setAttribute("Inverter_Battery_Act_Price",String.valueOf(ht_Inverter_Battery.get("bat_act_price")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Act_Price :" + String.valueOf(ht_Inverter_Battery.get("bat_act_price")));
						
						req.setAttribute("Inverter_Battery_Witbat_Price",String.valueOf(ht_Inverter_Battery.get("bat_witbat_price")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Witbat_Price :" + String.valueOf(ht_Inverter_Battery.get("bat_witbat_price")));
						
						req.setAttribute("Inverter_Battery_Ret_Price",String.valueOf(ht_Inverter_Battery.get("bat_ret_price")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Ret_Price :" + String.valueOf(ht_Inverter_Battery.get("bat_ret_price")));
						
						req.setAttribute("Inverter_Battery_Flag",String.valueOf(ht_Inverter_Battery.get("battery_type_flag")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Flag :" + String.valueOf(ht_Inverter_Battery.get("battery_type_flag")));
						
						req.setAttribute("Inverter_Battery_Stock",String.valueOf(ht_Inverter_Battery.get("model_stock")));
						LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Stock :" + String.valueOf(ht_Inverter_Battery.get("model_stock")));
					...
					req.setAttribute("Inverter_Name",String.valueOf(ht.get("inverter_name")));
					LogLevel.DEBUG(5, new Throwable(), "Inverter_Name :" + String.valueOf(ht.get("inverter_name")));
					...
					req.setAttribute("Inverter_Battery_Pic",String.valueOf(ht.get("inverter_battery_pcs")));
					LogLevel.DEBUG(5, new Throwable(), "Inverter_Battery_Pic:" + String.valueOf(ht.get("inverter_battery_pcs")));
