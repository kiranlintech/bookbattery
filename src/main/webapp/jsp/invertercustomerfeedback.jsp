...
String mobile_number = (String) request.getAttribute("consumer_mobnumber");
String inverter_make = (String) request.getAttribute("inverter_make");
String inverter_model = (String) request.getAttribute("inverter_model");
String existing_battery_make = (String) request.getAttribute("existing_battery_make");
String existing_battery_model = (String) request.getAttribute("existing_battery_model");
String existing_no_batteries = (String) request.getAttribute("existing_no_batteries");
...
String existing_battery_warranty_expiry = (String) request.getAttribute("existing_battery_warranty_expiry");
String inverter_status_charge_on = (String) request.getAttribute("inverter_status_charge_on");
String inverter_status_main_on = (String) request.getAttribute("inverter_status_main_on");
String inverter_status_inverter_on = (String) request.getAttribute("inverter_status_inverter_on");
String inverter_status_overload = (String) request.getAttribute("inverter_status_overload");
...
inverter_make=inverter_make.replace("_"," ");
inverter_model=inverter_model.replace("_"," ");
existing_battery_make=existing_battery_make.replace("_"," ");
existing_battery_model=existing_battery_model.replace("_"," ");

String inverter_make_model=inverter_make+" "+inverter_model;
String existing_battery_make_model=existing_battery_make+" "+existing_battery_model;
%>
    ...
    <div class="main container" style="margin-top: 0px;">
      <div class="row">
		...
		<div class="row"> 
			...
			<div class="col-sm-12 col-xs-12 col-md-12">			
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">	<label for="inverter_make_model">Your Product Make and Model :</label>	<input type="tel" class="form-control yes" id="inverter_make_model" style="font-weight: 600;"  placeholder="Amaron" readonly="readonly" value="<%=inverter_make_model%>" maxlength="10"></div>
				</div>					
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">	<label for="existing_battery_make_model">Existing Battery Make and Model :</label>	<input type="tel" class="form-control yes" id="existing_battery_make_model" style="font-weight: 600;"  placeholder="Amaron" readonly="readonly" value="<%=existing_battery_make_model%>" maxlength="10"></div>
				</div>			
			</div>				
			<div class="col-sm-12 col-xs-12 col-md-12">			
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">	<label for="existing_battery_warranty_expiry">Existing Battery Warranty Expiry Date :</label>	<input type="tel" class="form-control yes" id="existing_battery_warranty_expiry" style="font-weight: 600;"  placeholder="Amaron" readonly="readonly" value="<%=existing_battery_warranty_expiry%>" maxlength="10"></div>
				</div>					
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">	<label for="existing_no_batteries">Existing Number of Batteries :</label>	<input type="tel" class="form-control yes" id="existing_no_batteries" style="font-weight: 600;"  placeholder="Amaron" readonly="readonly" value="<%=existing_no_batteries%>" maxlength="10"></div>
				</div>			
			</div>	
			<div class="col-sm-12 col-xs-12 col-md-12">			
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			<div class="col-sm-12 col-xs-12 col-md-12">			
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group"><label for="volts_power_off">Volts When Power is Off</label>	<input type="tel" class="form-control yes" style="font-weight: 600;" readonly="readonly" value="<%=volts_power_off%>" id="volts_power_off" placeholder="Yes" maxlength="10"></div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group"><label for="volts_power_on">Volts When Power is On</label>	<input type="tel" class="form-control yes" id="volts_power_on" style="font-weight: 600;" readonly="readonly" value="<%=volts_power_on%>" placeholder="Yes" maxlength="10"></div>
				</div>		
			</div>			
			<div class="col-sm-12 col-xs-12 col-md-12">			
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group"><label for="inverter_status_charge_on">Inverter Status When Power is On - Charging On</label>	<input type="tel" class="form-control yes" style="font-weight: 600;" readonly="readonly" value="<%=inverter_status_charge_on%>" id="inverter_status_charge_on" placeholder="Yes" maxlength="10"></div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group"><label for="inverter_status_main_on">Inverter Status When Power is On - Main On</label>	<input type="tel" class="form-control yes" id="inverter_status_main_on" style="font-weight: 600;" readonly="readonly" value="<%=inverter_status_main_on%>" placeholder="Yes" maxlength="10"></div>
				</div>		
			</div>			
			<div class="col-sm-12 col-xs-12 col-md-12">			
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group"><label for="inverter_status_inverter_on">Inverter Status When Power is Off - Inverter On</label>	<input type="tel" class="form-control yes" style="font-weight: 600;" readonly="readonly" value="<%=inverter_status_inverter_on%>" id="inverter_status_inverter_on" placeholder="Yes" maxlength="10"></div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group"><label for="inverter_status_overload">Inverter Status When Power is Off - Over Load On</label>	<input type="tel" class="form-control yes" id="inverter_status_overload" style="font-weight: 600;" readonly="readonly" value="<%=inverter_status_overload%>" placeholder="Yes" maxlength="10"></div>
				</div>		
			</div>
			<div class="col-sm-12 col-xs-12 col-md-12">	
				<%
...
$('.button-continue').click(function(){
	...
	var inverter_make_model=$('#inverter_make_model').val();
	var existing_battery_make_model=$('#existing_battery_make_model').val();
	var existing_battery_warranty_expiry=$('#existing_battery_warranty_expiry').val();
	var existing_no_batteries=$('#existing_no_batteries').val();
	var terminalclean=$('#terminalclean').val();
	var batteryclean=$('#batteryclean').val();
	var volts_power_off=$('#volts_power_off').val();
	var volts_power_on=$('#volts_power_on').val();
	...
	var inverter_status_charge_on=$('#inverter_status_charge_on').val();
	var inverter_status_main_on=$('#inverter_status_main_on').val();
	var inverter_status_inverter_on=$('#inverter_status_inverter_on').val();
	var inverter_status_overload=$('#inverter_status_overload').val();
    ...
    var service_eng_mobile=$('#service_eng_mobile').val();
		...
		({					 
			type: "GET",
			url: "/bookbattery/feedback?hidWhatToDo=insertcustomerfeedbackinverter",
			data: {
				   ordernumber: ordernumber,
				   username: username,
				   usermobilenumber: usermobilenumber,
				   inverter_make_model: inverter_make_model,
				   existing_battery_make_model: existing_battery_make_model,
				   existing_no_batteries: existing_no_batteries,
				   existing_battery_warranty_expiry: existing_battery_warranty_expiry,
				   ...
				   inverter_status_charge_on: inverter_status_charge_on,
				   inverter_status_main_on: inverter_status_main_on,
				   inverter_status_inverter_on: inverter_status_inverter_on,
				   inverter_status_overload: inverter_status_overload,
				   message: message,
