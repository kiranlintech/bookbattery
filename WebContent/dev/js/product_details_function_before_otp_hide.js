...
function UpdateProduct_Filter()
{
	...
	{
		setCookie("product_state_cookie", product_state,ctime)
	}	
	...
	{
		setCookie("product_city_cookie", product_city,ctime)
	}
						...
						<div class='col-md-12'>\
							<h4 class='hide'> Personal Details</h4>\
							  <div class='form-group'>\
								...
								<small id='order-form-usermobile-number-help' class='form-text text-muted'> We well send OTP to your mobile number for verification. Need help in placing order <b>Call +91 96034 67559</b> or <a href='javascript:Open_Chat()' tabindex='-1'><span class='label label-default chat-with-us' tabindex='-1'>Chat with Us</span></a></small>\
							  </div>\
							 ...
							 <div class='modal-footer' style='padding-left: 0px; padding-right: 0px;'>\
								  <div style=' float: right;  text-align: right;' id='order-form-usermobile-number-btn-div'>\
									<button type='button' class='button btn-cart button-sendotp pull-right' onClick='javascript:SendSmsConfirmation()'>Send Me OTP</button>\
								  </div>\
				...
				if(product_type_page=="Bike Batteries" && showdelivery==true)
				{
					...
					<div class='col-xs-12'>\
						<div class='col-md-12'>\
							...
							<h4 style='margin: 15px;'><b>Do you require Home Delivery ?</b></h4>\
							<div class='form-group'>\
								<div class='' style='padding-left: 40px;'>\
									<div class='payment_radio'>\
										<div class='payment_radio-success'>\
											...
											<label for='Delivery_Mode-1'><span class='icon-check payment-mode-icon'> </span>&nbsp;YES ( + Delivery charges 300 Rs on Price)</label>\
										</div>\
										<div class='payment_radio-success'>\
							...
							<div class='form-group'>\
								<div class='' style='padding-left: 40px;'>\
									<div class='payment_radio'>\
										...
										<div class='payment_radio-success'>\
											<input type='radio' name='Payment_Mode' id='Payment_Mode-8'  value='Online Payment After Fitment' />\
											<label for='Payment_Mode-8'><span class='icon-money payment-mode-icon'> </span>&nbsp;Online Payment After Fitment</label>\
										</div>\
										<div class='payment_radio-success'>\
										...
										<div class='payment_radio-success'>\
											<input type='radio' name='Payment_Mode' id='Payment_Mode-7'  value='EMI' />\
											<label for='Payment_Mode-7'><span class='icon-calendar-empty payment-mode-icon'> </span>&nbsp;EMI - Equated Monthly Installment (Payments above 3000) </label>\
										</div>\
									</div>\
							...
							<h4 class='hide'> Order Details</h4>\
							 <div class='form-group'>\
								...
								<div id='current_order_details'  style=' font-size: 14px;'>\
									...
									<tr><th><b>Delivery Charges&nbsp;:</b></th><td>300 Rs</td></tr>\
								</div>\
							</div>\
...
var WithOldBattery_Percent =$("#WithOldBattery_Percent").val();
    ...
    $('#check_with_without_battery input:radio').change(function() {
		...
		if(battery_buy_type=="New" || battery_buy_type=="without-old")
		{
			...
			$('#final_price').html("<i class='icon-inr' aria-hidden='true'></i>&nbsp;"+Price_Without_Battery * order_product_qty);		
		...
		else if(battery_buy_type=="Replaced" || battery_buy_type=="with-old")
		{
			...
			$('#final_price').html("<i class='icon-inr' aria-hidden='true'></i>&nbsp;"+Price_With_Battery * order_product_qty);		
    ...
    $('.Battery_Quantity_value').change(function() {
		...
		{
			$('#final_price').html("<i class='icon-inr' aria-hidden='true'></i>&nbsp;"+order_inverter_discount_price * order_product_qty);
		}
		else
		{
			alert("Opps !. Some thing went wrong. Please reload the Page.");
