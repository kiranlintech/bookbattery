...
function funClickSubmit()
{
	...
	var strDateOpt = document.misselconfirm.dates.value;
	...
	document.misselconfirm.action="../../../servlet/MISOperatorServiceDetails?hidWhatToDo=getconfirmedordersmis&city="+city+"&keyword="+keyword+"&dates="+strDateOpt+"&txtFromDate="+strFromDate+"&txtToDate="+strToDate;
		...
		<tr>
			...
			<td width="75%" align="left" valign="top">
				...
				<tr>
					...
					<tr><td align="left" class="subheading"></td><td width="50%"align="right"><a href="../../../jsp/serviceoperator/ordermis/misoption.jsp?dates=<%=strDateOpt%>&txtFromDate=<%=strFromDate%>&txtToDate=<%=strToDate%>" class="onclick1">Back</a></td></tr>
					<tr>
						<td>
