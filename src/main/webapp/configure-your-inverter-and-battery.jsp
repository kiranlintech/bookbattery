  ...
  <div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <ul>
          ...
          <li class="category13"><strong>Configure Your Inverter and Inverter Battery</strong></li>
        </ul>
      </div>
    </div>
  </div>
    <ol class="hide" itemscope itemtype="http://schema.org/BreadcrumbList">
	  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
		<a itemscope itemtype="http://schema.org/Thing" itemprop="item" href="<%=publicUrl%><%=baseurldirectory%>configure-your-inverter-and-battery.jsp">
		  <span itemprop="name">Configure Your Inverter and Inverter Battery</span>
		</a>
					...
					<div class="stepwizard row">
						<div class="stepwizard-row setup-panel">
							...
							<div class="stepwizard-step">
								...
								<p>Select your Battery Capacity</p>
							</div>
...
<!---################################## JS Include Ends  ################################------>
	<script type="text/javascript" src="<%=publicUrl%>/bookbattery/dev/js/configure-all.js?v=6"></script>
