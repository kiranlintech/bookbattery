					 ...
					 <form class="form-horizontal" id="myform">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-6 col-xs-offset-6">
                                        <button type="button" class="btn bg-indigo m-t-15 waves-effect" onclick="funtoAddTrolleyDetails()">ADD TROLLEY</button>
...
function funtoAddTrolleyDetails(){
	...
	var storeid	= $("#storeid").val();
	  ...
	  $.ajax({
			type: "GET",
			url: "/bookbattery/servlet/BatterystoreInventoryDetails?hidWhatToDo=addtrolleyinventory",
