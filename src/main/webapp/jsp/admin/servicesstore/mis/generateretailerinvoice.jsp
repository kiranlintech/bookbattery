<%--
    Document   : Generate Retailer Invoice
	File name  : generateretailerinvoice.jsp
...
LogLevel.DEBUG(5,new Throwable(),"Inside correct jsp: "+RetailerVector);
%>
...
function funToGenerateinvoice(varButton)
{
	...
	if(fyear==year)
		...
		var xmlhttp= "";
		var resp= "";
		var url ="../../../../servlet/GenerateServiceRetailerInvoice?hidWhatToDo=Generateinvoicereport&retailer="+retailer+"&txtFromDate="+fdate+"&txtToDate="+tdate+"&months="+months;
...
function FunReset()
{
	location.href="../../../../jsp/admin/servicesstore/mis/generateretailerinvoice.jsp"
}
</script>
<style type="text/css">
</style>
