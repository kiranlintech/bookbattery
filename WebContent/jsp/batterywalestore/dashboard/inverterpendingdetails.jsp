                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix" id="misinverterreports"></div>
						</div>
                    </div>
                </div>
            </div>
...
function GetMISReports(){
	...
	var order_status = "Not Confirmed";
	
	$.ajax({
		type: "GET",
		url: "/bookbattery/servlet/BatterystoreMISReports?hidWhatToDo=misinverterdetails",
		data: {todate: todate, fromdate: fromdate, store_id: store_id, store_name: store_name, brand_type: brand_type, payment_type: payment_type, order_status: order_status },
		success: function(data){
			
			//alert(data);
			 
			$("#misinverterreports").html(data);
