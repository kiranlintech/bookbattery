...
cities['Andhra Pradesh'] = new Array('<-----select city----->', 'Adilabad', 'Adoni', 'Amadalavalasa', 'Amalapuram', 'Anakapalle', 'Anantapur', 'Armur', 'Badvel', 'Banganapalle', 'Bapatla', 'Bellampalle', 'Bethamcherla', 'Bhadrachalam', 'Bhainsa', 'Bheemunipatnam', 'Bhimavaram', 'Bhongir', 'Bobbili', 'Bodhan', 'Chapirevula', 'Chilakaluripet', 'Chirala', 'Chittoor', 'Cuddapah', 'Devarakonda', 'Dharmavaram', 'Dhone', 'Eluru', 'Farooqnagar', 'Gadwal', 'Gudivada', 'Gudur', 'Guntakal', 'Guntur', 'Hindupur', 'Hyderabad', 'Ichchapuram', 'Jaggaiahpet', 'Jagtial', 'Jammalamadugu', 'Jangaon', 'Kadiri', 'Kagaznagar', 'Kakinada', 'Kamareddy', 'Kandukur', 'Karimnagar', 'Kavali', 'Khammam', 'Koratla', 'Kothagudem', 'Kovvur', 'Krishna', 'Kurnool', 'Macherla', 'Machilipatnam', 'Madanapalle', 'Mahbubnagar', 'Mancherial', 'Mandamarri', 'Mandapeta', 'Mangalagiri', 'Manugur', 'Markapur', 'Medak', 'Metpalle', 'Miryalaguda', 'Nagari', 'Nalgonda', 'Nandyal', 'Narasapur', 'Narasaraopet', 'Narayanpet', 'Narsipatnam', 'Nellore', 'Nidadavole', 'Nirmal', 'Nizamabad', 'Nuzvid', 'Ongole', 'Palacole', 'Palamaner', 'Palasa Kasibugga', 'Palwancha', 'Parvathipuram', 'Pedana', 'Peddapuram', 'Piduguralla', 'Pithapuram', 'Ponnur', 'Prakasam', 'Proddatur', 'Pulivendla', 'Punganur', 'Puttaparthi', 'Puttur-AP', 'Rajahmundry', 'Rajam', 'Rajampet', 'Ramachandrapuram', 'Ramagundam', 'Rayachoti', 'Rayadurg', 'Repalle', 'Sadasivpet', 'Salur', 'Samalkot', 'Sangareddy', 'Sathupalle', 'Sattenapalle', 'Secunderabad', 'Siddipet', 'Sircilla', 'Srikakulam', 'Srikalahasti', 'Suryapet', 'Tadepalle', 'Tadepalligudem', 'Tadpatri', 'Tandur', 'Tanuku', 'Tenali', 'Tirupati', 'Tuni', 'Venkatagiri', 'Vicarabad', 'Vijayawada', 'Vinukonda', 'Visakhapatnam', 'Vizianagaram', 'Wanaparthy', 'Warangal', 'Yellandu', 'Yemmiganur', 'Zahirabad');
...
function onClickRetailerSubmit()
{
	...
	if(address2=="www.amaronbatterywale.com" )
	{
		address2="";
	}
	else
...
{		
	...
	else
	{
		...
		if(eretaddress2 == "www.amaronbatterywale.com")
		{
			errMsg ="<br><table align='center' border='0' cellpadding='0' cellspacing='0'><tr class='pages'><td align='center'>Please enter Web Address.</br></td></tr><tr height='20'><td></td></tr><tr height='20'><td align='center'><input type='button' value='&nbsp;&nbsp;OK&nbsp;&nbsp;' onclick='close_popup_address2eret();' class='button4'><br></td></tr>";
			document.getElementById("popup").style.display='block';
			greyout(true);
