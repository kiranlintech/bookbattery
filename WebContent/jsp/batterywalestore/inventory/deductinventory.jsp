				...
				<div class="card">
                  ...
                  <div class="body">
                			<div class="alert bg-green" id="success_div" style="display:none">
                                Successfully Deducted Inventory Details.
                            </div> 
                            <div class="alert bg-red" id="failure_div" style="display:none">
                                 Failed to Deduct Inventory Details.
                            </div>
					 <form class="form-horizontal" id="myform">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-6 col-xs-offset-6">
                                        <button type="button" class="btn bg-grey m-t-15 waves-effect" onclick="funtoDeleteInventoryDetails()">DELETE INVENTORY</button>
                                         <button type="button" class="btn bg-blue-grey m-t-15 waves-effect" onclick="funtoReset()">RESET</button>
                                    </div>
                                </div>
                            </form>
...
function funtoDeleteInventoryDetails(){
	...
	var storeid	= $("#storeid").val();
	  ...
	  $.ajax({
			type: "GET",
			url: "/bookbattery/servlet/BatterystoreInventoryDetails?hidWhatToDo=deleteinventory",
