					 ...
					 <form class="form-horizontal" id="myform">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-6 col-xs-offset-6">
                                        <button type="button" class="btn bg-light-green m-t-15 waves-effect" onclick="funtoAddReturnDetails()">ADD</button>
...
function funtoAddReturnDetails(){
	...
	// alert(storeid);
	 $.ajax({
			type: "GET",
			url: "/bookbattery/servlet/BatterystoreScrapDetails?hidWhatToDo=insertreturnbatterydetails",
			data: {battery_type: batterytype, battery_brand : batterybrand, battery_name: battery_name, battery_model: battery_model, quantity: quantity, storename: storename, storeid: storeid },
			success: function(data){
				// alert(data);
