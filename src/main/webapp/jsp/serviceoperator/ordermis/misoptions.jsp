<%--
	...
	File name  : misoptions.jsp
    Created on : Feb 17th, 2016
...
{
	var varRadioGroup = document.forms["misoption"].rdbWhatSelected;
	var fdate=document.misoption.txtFromDate1.value;
	var tdate=document.misoption.txtToDate1.value;
...
if(dvalue=="selected")
	...
	document.misoption.action="../../../jsp/serviceoperator/ordermis/misoption.jsp?dates="+dvalue+"&txtFromDate="+fdate+"&txtToDate="+tdate;
				...
				<tr>
					...
					<tr>
						<td>
							...
							<tr>
								<td class="subheading" align="left" size="2">Ordered&nbsp;Details</td>
							</tr>
							<tr>
								<td>
												...
												<td>
													<table width="100%" align="center" border="0" cellspacing="0" bgcolor="#FFFFFF" cellpadding="0">
														...
														<tr>
															...
															<td class="table1" align="left" width="60%"><a href="../../../jsp/serviceoperator/ordermis/misoption.jsp?dates=current" class="insidecontent"  style="text-decoration:none">&nbsp;&nbsp;Current Month</a>
															</td>
														</tr>
														<tr>
															...
															<td class="table2" align="left" width="50%"><a href="../../../jsp/serviceoperator/ordermis/misoption.jsp?dates=candpmonth" class="insidecontent"  style="text-decoration:none">&nbsp;&nbsp;From Previous Month</a>
															</td>
														</tr>
														<tr>
															...
															<td class="table1" align="left" width="50%"><a href="../../../jsp/operator/ordermis/misoption.jsp?dates=sixmonths" class="insidecontent"  style="text-decoration:none">&nbsp;&nbsp;Past Six Months</a>
															</td>
														</tr>
														<tr>
															<td class="table2" align="right" height="25" width="50%">
