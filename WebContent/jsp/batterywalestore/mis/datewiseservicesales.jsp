                    ...
                    <div class="card">
                        ...
                        <div class="body">
                               <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
	                                <label for="to_date"> Service Type:&nbsp;<font color="red">*</font></label>
									<div class="form-group">
										<div class="form-line"> 
								...
								<br/>
                                    <div class="form-group">
                                         <button type="button" class="btn bg-pink waves-effect" onclick="GetServicesSalesReports()">
                            ...
                            <div class="row clearfix" id="servicesales_report"></div>
						</div>
                    </div>
                </div>
            </div>
...
function GetServicesSalesReports(){
	...
	if (selectValidation("","service_type","select") == false)
	{
		return;
	...
	$.ajax({
		type: "GET",
		url: "/bookbattery/servlet/BatterystoreInventoryDetails?hidWhatToDo=getsalesservicesreport",
		data: {fromdate : fromdate, todate: todate, service_type: service_type, store_name: store_name},
		success: function(data){
			
			//alert(data); 
			$("#servicesales_report").html(data);
