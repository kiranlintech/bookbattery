...
function funClickSubmit()
{
	...
	var strToDates = document.misoption.txtToDate.value;
		...
		document.misoption.action="../../../servlet/MISOperatorServiceDetails?hidWhatToDo=getlocationsordermis&dates="+strDateOpts+"&txtFromDate="+strFromDates+"&txtToDate="+strToDates+"";
		...
		<tr>
			...
			<td width="75%" align="left" valign="top">
				...
				<tr>
					...
					<tr><td align="left" class="subheading"></td><td width="50%"align="right"><a href="../../../jsp/serviceoperator/ordermis/misoptions.jsp?dates=<%=strDateOpt%>&txtFromDate=<%=strFromDate%>&txtToDate=<%=strToDate%>" class="onclick1">Back</a></td></tr>
					<tr>
						<td>
												...
												<td bgcolor="#FFFFFF" align="center">
													<table width="80%" align="center" border="0" cellspacing="0" bgcolor="#FFFFFF" cellpadding="0">
														...
														<tr>
															...
															<td class="table2" align="left" width="90%"><a href="../../../servlet/MISOperatorServiceDetails?hidWhatToDo=getlocationsordermis&keyword=All&dates=<%=strDateOpt%>&txtFromDate=<%=strFromDate%>&txtToDate=<%=strToDate%>" class="insidecontent"  style="text-decoration:none">&nbsp;Based on All Orders</a>
															</td>
														</tr>
