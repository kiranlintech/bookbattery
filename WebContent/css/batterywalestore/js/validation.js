...
{
// Initializing Variables With Regular Expressions	
var mobilenumber_regex = /^[789]\d{9}$/;
var text_tmp_val = $("#"+id+"").val();
...
{
	var text_tmp_val = $("#"+id+"").val();
	if ((text_tmp_val == 0 || text_tmp_val == "" || text_tmp_val == "default"  || text_tmp_val == "null"  || text_tmp_val == null  || text_tmp_val == "0" || text_tmp_val == "defaults"  || text_tmp_val == "-1" ) && $("#"+id+"").hasClass("yes"))
	{
